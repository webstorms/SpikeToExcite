...
The pre-trained model, experimental data and pre-computed results can be found under the releases of this repository - the data.zip. Make sure to place the unzipped downloaded `data` directory in the project path. Note: You will still need to download the natural stimulus dataset (see below).
...
3. Natural stimulus dataset, can be downloaded from: https://figshare.com/articles/dataset/Natural_movies/24265498. Make sure to download the filtered dataset. You can place this file anywhere on your machine, but need to define this path at the beginning of some notebooks.
